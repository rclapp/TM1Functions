...
def generate_attribute_df(tm1, dimension):
    """
    ...
    """
    # define MDX Query
    mdx = 'SELECT [}}ElementAttributes_{}].[}}ElementAttributes_{}].ALLMEMBERS ' \
          'ON 0, [{}].[{}].ALLMEMBERS ON 1 ' \
          'FROM [}}ElementAttributes_{}]'.format(dimension, dimension, dimension, dimension, dimension)
